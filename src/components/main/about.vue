    ...
    <b-container fluid>
      <b-row>
        ...
        <b-col md="8">
          ...
          <h3>grepiu.com</h3>
          <div>
            <b class="c-name">Server</b>&nbsp;AWS EC2(t3a.small)
          </div>
          <div>
          ...
          <div>
            <b class="c-name">lib</b>Google Maps, Vue-editor,vue-router, Quill, Axios, moment,
            highlight js, marker-clusterer-plus, vue-carousel, webstomp-client
          </div>
          <br>
          <div>
            <h1>끄적끄적</h1>
          </div>
          <carousel id="ca" :loop="true" :perPage="1" :spacePadding="2" :autoplay="carousel.auto"
                    :speed="carousel.speed">
            <b-tooltip :show.sync="carousel.tooltip" target="ca" placement="top">
              마우스 <strong>swipe!!</strong>
            </b-tooltip>
            <slide class="label bg store">
              <div class="home_inner">
                <div
                  style="color: #ffffff;font-size: 2vmax;font-weight: bold;text-align: end; width: 60vw;">
                  그렙 플레이스
                </div>
                ...
                <div class="home_more" style="text-align: end;">
                  <a href="https://itunes.apple.com/app/id1507847743">
                    <apple-market class="icon-2x" title="Apple 스토어" :size="100" decorative
                                  fill-color="#00000"/>
                  </a>
                  <a
                    href="https://play.google.com/store/apps/details?id=com.grepiu.gsapp.grep_search_app">
                    <android-market class="icon-2x" title="구글 플레이" :size="100" fill-color="#FFFFFF"
                                    decorative/>
                  </a>
            ...
            <slide class="label bg selenium">
              <div class="home_inner">
                <div class="home_head">우리 어때</div>
                <div class="home_content">
                  <p>사진을 통한 애정도 측정앱</p>
                </div>
                <div class="home_more" style="text-align: end;">
                  <a
                    href="https://play.google.com/store/apps/details?id=faceapp.grepiu.com.flutter_face_app&hl=ko">
                    <android-market class="icon-2x" title="구글 마켓" :size="100" fill-color="#FFFFFF"
                                    decorative/>
                  </a>
                </div>
              </div>
            ...
            <slide class="label bg movie">
              <div class="home_inner">
                <div class="home_head">크롤링 테스트</div>
                <div class="home_content">
            ...
            <slide class="label bg websocket">
              <div class="home_inner">
                ...
                <div class="home_content">
                  <p>Websocket을 이용한 채팅</p>
                </div>
                <div class="home_more">
                  <b-btn variant="primary" href="https://conf.grepiu.com" target="_blank">확인하기(새창)
                  </b-btn>
                </div>
              </div>
            </slide>
            <slide class="label bg slack">
              <div class="home_inner">
                <div class="home_head">Slack 채널</div>
                <div class="home_content">
                  <p>- 개발 도구</p>
                </div>
                <div class="home_more">
                  <b-btn variant="primary" href="https://iustudy.slack.com" target="_blank">
                    확인하기(새창)
                  </b-btn>
                </div>
              </div>
...
.store {
  background-image: url("/static/img/bg/store.jpg");
}
